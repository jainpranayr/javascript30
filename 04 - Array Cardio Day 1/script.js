...
console.table(inventors.sort((a, b) => (a.year > b.year ? true : false)));
...
const oldest = inventors.sort((a, b) => {
	...
	return lastGuy > nextGuy ? true : false;
});
...
// console.table(
// 	links.map((link) => link.textContent).filter((name) => name.includes("de"))
// );
...
console.table(
	people.sort((a, b) => {
		...
		aLastName > bLastName ? true : false;
	})
);
